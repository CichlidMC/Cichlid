...
public final class EntrypointHelper {
	...
	/// error will be re-thrown as a [EntrypointException] which may optionally be caught.
	/// This will stop invoking entrypoints early; if you want to always invoke all of them, use
	/// [#invokeSafe(Class, String, BiConsumer, boolean, Consumer)].
	...
	/// Identical to [#invoke(Class, String, BiConsumer, boolean)], but errors during invocation
