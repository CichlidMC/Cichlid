...
import fish.cichlidmc.cichlid.api.dist.ClientOnly;
import fish.cichlidmc.cichlid.api.dist.DedicatedServerOnly;
...
public final class EnvironmentStripper {
	...
	public static boolean strip(ClassNode node) {
